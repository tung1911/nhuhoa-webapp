...
export const mockPages: FacebookPage[] = [
  { id: 'p1', name: 'Page Nâng mũi Như Hoa', isVisible: true, isAiEnabled: false, avatar: '', isConnected: true },
  { id: 'p2', name: 'Page Da liễu Như Hoa', isVisible: true, isAiEnabled: false, avatar: '', isConnected: true },
  { id: 'p3', name: 'Page Nha khoa Như Hoa', isVisible: true, isAiEnabled: false, avatar: '', isConnected: true },
